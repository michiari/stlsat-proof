...
\newcommand*{\pactive}{P}
\DeclareMathOperator{\levt}{E}
\DeclareMathOperator{\eevt}{e}
\DeclareMathOperator{\cevt}{cE}

\newcommand{\under}[1]{\underaccent{\bar}{#1}}
\newcommand{\tinv}[0]{\mathcal{T}}

\newcommand*{\oldjump}{$\mathsf{JUMP}_\mathsf{O}$}

\newcommand{\parof}[2]{\langle #1\rangle_{#2}}
